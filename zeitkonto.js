      ...
      <div class="entnahme-item">
        ...
        <div class="entnahme-right">
          ...
          <div class="entnahme-actions">
            ...
            <button class="icon-btn danger" onclick="Zeitkonto.deleteEntnahme(${en.id})">🗑</button>
          </div>
        </div>
      </div>`).join('')}</div>`;
  },
